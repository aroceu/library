...
<?php include('header.php');?>
	...
	<h1>aroceu's library</h1>
            ...
            <div id="blurb"><p>Welcome to my media library! Below is a non-comprehensive yet historically thorough list of media that has entertained me to some significance once, if not right now. Many I no longer enjoy, but used to mean something to me at one point, and I take no shame in that. Others, meanwhile, have a place in my heart forever.</p> <p>I abide by the principle that if I don't enjoy something, I don't have to finish it.</p>
